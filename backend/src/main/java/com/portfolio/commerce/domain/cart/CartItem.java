...
/**
 * A {@link Product} inside a {@link Cart}.
 *
 * The unique constraint (cart_id, product_id) prevents the same product from
 * being added twice to the same cart. Quantity must be strictly positive.
 */
@Entity
